...
export const defaultPortfolioData: PortfolioData = {
  ...
  "about": {
    ...
    "learningTimeline": [
      {
        "date": "2023",
        "title": "C & Logic Foundations",
        "desc": "Learned variables, loops, arrays, pointers, and manual memory principles at college."
      },
      {
        "date": "2024 (Early)",
        "title": "Java OOP Core",
        "desc": "Mastered polymorphism, inheritance, collections, interface designs, and multithreading in Java."
      },
      {
        "date": "2024 (Mid)",
        "title": "SQL & RDBMS",
        "desc": "Practiced complex joins, constraints, indexing, transactions, and ER designs with MySQL."
      },
      {
        "date": "2025 (Early)",
        "title": "Vite + React & Tailwind",
        "desc": "Dove into state, effects, reusable layouts, components, hooks, and responsive design systems."
      },
      {
        "date": "2025 (Mid)",
        "title": "Spring Boot RESTful APIs",
        "desc": "Engineered MVC, Spring Security, dependency injection, JPA/Hibernate repositories, and REST endpoints."
      },
      {
        "date": "2026",
        "title": "Full-Stack Integrations",
        "desc": "Constructing ERP applications, deploying microservices, and setting up automated CI/CD pipelines."
      }
    ]
  },
  "skills": [
      ...
      "skillItems": [
        {
          ...
          "level": "Expert",
          "percentage": 90,
          "description": "Object-oriented concepts, multithreading, collections, streams, generic programming.",
          "usedInProjects": [
        ...
        },
        {
          ...
          "level": "Advanced",
          "percentage": 80,
          "description": "ES6 syntax, DOM manipulation, promises, async/await, fetch APIs.",
          "usedInProjects": [
            "ERP Management System",
            "Hospital Management System",
            "Guess Game"
        ...
        },
        {
          ...
          "level": "Advanced",
          "percentage": 85,
          "description": "Schema design, writing complex joins, query optimization, triggers, indices, views.",
          "usedInProjects": [
            "ERP Management System",
            "Hospital Management System"
          ]
        },
        {
          ...
          "level": "Intermediate",
          "percentage": 70,
          "description": "File handling, scripting, scripting tools, basic data analysis.",
          "usedInProjects": []
        },
        {
          "name": "C",
          "level": "Advanced",
          "percentage": 80,
          "description": "Pointers, dynamic allocations, algorithm design, standard libraries.",
          "usedInProjects": [
      ...
      "skillItems": [
        {
          ...
          "level": "Advanced",
          "percentage": 85,
          "description": "Hooks (useState, useEffect, useContext), routing, conditional rendering, state management.",
          "usedInProjects": [
            "ERP Management System",
            "Hospital Management System"
          ]
        },
        {
          ...
          "level": "Expert",
          "percentage": 90,
          "description": "Semantic markup, CSS grids, flexbox layout, responsive typography, media queries.",
          "usedInProjects": [
            "ERP Management System",
            "Hospital Management System",
            "Guess Game"
        ...
        },
        {
          ...
          "level": "Advanced",
          "percentage": 85,
          "description": "Utility-first design, layout custom utilities, dark/light themes, custom animations.",
          "usedInProjects": [
            "ERP Management System",
            "Hospital Management System"
          ]
      ...
      "skillItems": [
        {
          ...
          "level": "Advanced",
          "percentage": 85,
          "description": "Spring Data JPA, Spring Security, REST controller, dependency injection, service mapping.",
          "usedInProjects": [
            "ERP Management System",
            "Hospital Management System"
          ]
        },
        {
          ...
          "level": "Advanced",
          "percentage": 85,
          "description": "Endpoint design, HTTP methods, JSON responses, error handling middleware.",
          "usedInProjects": [
            "ERP Management System",
            "Hospital Management System"
          ]
        },
        {
          ...
          "level": "Advanced",
          "percentage": 85,
          "description": "Relational database model, foreign keys, transaction logs, relational schemas.",
          "usedInProjects": [
            "ERP Management System",
            "Hospital Management System"
          ]
      ...
      "skillItems": [
        {
          ...
          "level": "Advanced",
          "percentage": 85,
          "description": "Branching workflows, staging commits, resolving merge conflicts, remote repo management.",
          "usedInProjects": [
            "All major projects"
          ]
        },
        {
          ...
          "level": "Advanced",
          "percentage": 80,
          "description": "API request collection testing, environment variables, authentication header simulation.",
          "usedInProjects": [
            "ERP Management System",
            "Hospital Management System"
          ]
        },
        {
          ...
          "level": "Expert",
          "percentage": 90,
          "description": "Integrated dev setups, extension configs, quick shortcuts, terminal configs.",
          "usedInProjects": [
            "All major projects"
          ]
        }
  ...
  "education": [
    {
      ...
      "activities": [
        ...
        "Tech Symposium Volunteer",
        "Web Design Organizer"
      ],
      "certificates": [
